...
new #[Title('Home'), Layout('layouts.guest')] class extends Component {
...
<div class="relative isolate px-6 py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl">
      <div class="text-center">
        <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Covid Road<br />To Glory</h1>
